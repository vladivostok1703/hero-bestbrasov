...
<?php
if(check_catproject_exists($_GET['edit']))
{
	$info = get_catproject($_GET['edit']);
?>
	    <?php if($_POST['go']=="y"){ echo edit_catproject($_POST['csrf'],$_GET['edit'],$_POST['name']); get_catproject($_GET['edit']); } ?>
            <div class="widgetbox">
...
?>
	    <?php if($_POST['go']=="y"){ echo add_catproject ($_POST['csrf'],$_POST['name']); } ?>
            <div class="widgetbox">
